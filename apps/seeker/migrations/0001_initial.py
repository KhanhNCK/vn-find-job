    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_hoso', models.CharField(default='', max_length=255, null=True)),
                ('nganh_nghe', models.IntegerField(default=0, null=True)),
                ('vi_tri_mong_muon', models.CharField(default='', max_length=255, null=True)),
                ...
                ('ten_cty_tung_lam', models.CharField(default='', max_length=255, null=True)),
                ('hinh_thuc_lam_viec', models.IntegerField(default=0, null=True)),
                ('muc_luong_toi_thieu', models.CharField(default='', max_length=255, null=True)),
                ('ten_bang_cap', models.CharField(default='', max_length=255, null=True)),
                ('don_vi_dao_tao', models.CharField(default='', max_length=255, null=True)),
                ('chuyen_nganh', models.CharField(default='', max_length=255, null=True)),
                ('thoi_gian_bat_dau', models.CharField(default='', max_length=255, null=True)),
                ('thoi_gian_ket_thuc', models.CharField(default='', max_length=255, null=True)),
                ('loai_tot_nghiep', models.IntegerField(default=0, null=True)),
                ('ngoai_ngu', models.CharField(default='', max_length=255, null=True)),
                ...
                ('status_hoso', models.IntegerField(default=0)),
